 ...
 * Versi: Final (No Browser Mobile Auto-Focus)
 */
...
function unlockSite() {
    ...
    /* 🎯 FIX ANTI-AUTO KEYBOARD MOBILE:
       Cek ukuran layar terlebih dahulu. Kita hanya tembak input.focus() jika layar lebar (PC / Desktop >= 768px).
       Jika dibuka di HP, biarkan panel terbuka anggun tanpa memaksa keyboard virtual mencuat naik! */
